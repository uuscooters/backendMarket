                    ...
                    <tbody>
                        @forelse ($food as $item)
                            <tr>
                                ...
                                <td class="border px-6 py4">{{ $item->name }}</td>
                                <td class="border px-6 py4">{{ number_format($item->price)}}</td>
                                <td class="border px-6 py4">{{ $item->rate }}</td>
                                <td class="border px-6 py4">{{ $item->types }}</td>
