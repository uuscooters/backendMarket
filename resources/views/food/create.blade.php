                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap mx-3 mb-6">
                                <div class="w-full px-3">
                                    ...
                                    <textarea name="description" class="@error('description') is-invalid @enderror appearance-none block w-full bg-gray-200 text-gray-700 text-left border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  id="grid-last-name" type="text" placeholder="Food description">{{ old('description') }}</textarea>
                                    @error('description')
                                    <span class="invalid-feedback" style="color: red"  role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
