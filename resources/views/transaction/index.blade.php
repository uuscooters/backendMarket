                ...
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        @forelse ($transaction as $item)
                            <tr>
                                <td class="border px-6 py4">{{ $item->id }}</td>
                                <td class="border px-6 py4">{{ $item->food->name }}</td>
                                <td class="border px-6 py4">{{ $item->user->name }}</td>
                                <td class="border px-6 py4">{{ $item->quantity }}</td>
                                <td class="border px-6 py4">{{ number_format($item->total) }}</td>
                                <td class="border px-6 py4">{{ $item->status }}</td>
                                <td class="border px-6 py4 text-center">
